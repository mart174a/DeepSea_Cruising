...
namespace DeepSea_Cruising
{
    class Ticket
    {
        ...
        public enum Port {Copenhagen, Stockholm, Singapore, Phuket}
        ...
        public Port FromDestination { get => fromDestination; }
        public Port ToDestination { get => toDestination; }
        ...
        public Ticket(string filePath)
        {
            ...
            this.fromDestination = (Port)Enum.Parse(typeof(Port), dataLines[1]);
            this.toDestination = (Port)Enum.Parse(typeof(Port), dataLines[2]);
        ...
        public static bool CreateNew()
        {
            ...
            if (!Validater.AskForValidtInputLoop("From Destination (Copenhagen, Stockholm, Singapore, Phuket) : ", Validater.IsPort, out newFromDestination))
                return false;
            if (!Validater.AskForValidtInputLoop("To Destination (Copenhagen, Stockholm, Singapore, Phuket) : ", Validater.IsPort, out newToDestination))
                return false;
